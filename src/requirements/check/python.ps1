$pythonVersion = invoke-executeCheckCommand "python --version" "Python non presente nella macchina"
if (!$pythonVersion) { return 'KO' }

$pythonVersion = $pythonVersion.split(' ')[1].split(".")
$pythonVersion = [Version]::new($pythonVersion[0], $pythonVersion[1], $pythonVersion[2])
...
if ($pythonVersion -lt $minVersion){
    invoke-WriteCheckLogs "La versione rilevata di Python e' la $pythonVersion\r\nE'consigliato avere una versione superiore alla $minVersion"
    return "VER"
}

invoke-WriteCheckLogs "La versione rilevata di Python $pythonVersion rispetta i requisiti\r\nMin Version: $minVersion."
return "OK"

# SIG # Begin signature block
# MIIkyAYJKoZIhvcNAQcCoIIkuTCCJLUCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU2oF/Dydcsf79NWpAeROxZznJ
# Y2uggh6kMIIFOTCCBCGgAwIBAgIQDue4N8WIaRr2ZZle0AzJjDANBgkqhkiG9w0B
...
# DjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBQ2ssxDwOTuCU30lYRVEDah
# 74CTojAkBgorBgEEAYI3AgEMMRYwFKASgBAAQwBBACAAVABvAG8AbABzMA0GCSqG
# SIb3DQEBAQUABIIBABJQonZg3vJ5+3XJgBP9BLrH6LJ4IO6adYLiV+/v9WpCo4rs
# w+8j7EyUMMgpY5xQ81UsCvz2NIMoG6zDiIUI9s3QbejoFEJJR0KnHObj5PL+S8q4
# EbXP7NjvDdJBkTN14QKtdDJfyxvDqJuX8U9rVeyMyz1fZ9uhlJi+zH4wa8L6eUhu
# nGFTzcWE4OwfMS/X6ImxkFxfXQ29LGCFXT/Ky+m6gydJ9mX+6NJdoAmTCVfY9aiR
# fiAh9A1LJs0VdJluYk5rgG5UtVL5ruAAdUMlQyYU2AlFIazAJHDmCTQPYapusfAo
# 36zNwO4CiSaNBf6fesa8sFVr8fJ6DqiW8yGoeeChggNLMIIDRwYJKoZIhvcNAQkG
...
# CSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcNMjMwNTI1MTEwNjA3WjA/BgkqhkiG
# 9w0BCQQxMgQwle4YtWjl6iCmZyxhrJjiA0OBrOmnJJ89UcGgQ7ZZG0CmJBYCY0VH
# Y9sosK42t63BMA0GCSqGSIb3DQEBAQUABIICABPbMB9+1aFztcBGyltEkDYCNiem
# u+d0i/rrpzh/MKqFfA0YMIaFpv/jwefEJPUNKUsPh8/n+KzoC20sbXCddn/Q89sG
# qLFvZ7WmapnpJ3Wh9eowUv37a4iyH4Lu/8CR+4rLMAo1pJjG/jXytvh7Syy/ce1b
# A4VB9JzHAF1e1YbHz10ec7ZMXpkq9bqYoATY/ExZoHNXbGB4T0TL2a0FSO0P4MlK
# Nuj2yVbubmEAv4vFA/cbJCtUBYdsvFEzdiD/VMGJBjIWfO/8Lfc7YUA3JDJwMTXH
# WQ9su5sji0KZ/BMHOKFM9e1d0kJY7PBRcSJJo3bolRJrAveSDmXMrfoHns+DRTpV
# DYgpFwrc3C+sOp0PyWNafql4PruQXmO4cOPmAEr6QyZqzA38mH49qdFREV6Vavx8
# LXFeZ6AGSMsDLxkYo0hpeWOCDX4hFDqv95MV7IrE9fhd1DR2g6tg69cL+W3WZtaW
# LgdNi9L1gptTsvoKqLgBVvfUEbEscO6a1/XzlzD2UaKWg+AyJmn390BsSiMMfaNI
# ZIwRyoyKwKjDtgslfW645n+0zTt87drvRlqL7VBbziFSIcXTgIpGzAwIXKUUKKmY
# vIblOdjF4bwXaKSm2igNvhxnnjtEWLLppEtAw/pZV5S6+6qZ4B8BRey4/oCjb2KY
# qtjGn9JbL/JfRE3K
