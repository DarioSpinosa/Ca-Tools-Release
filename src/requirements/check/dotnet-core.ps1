...
for ($i = 0; $i -lt $requirement["Versions"].Count; $i++){
  if ($dotNetVersions.Contains($requirement["Versions"][$i])) {
    invoke-WriteCheckLogs "La versione $($requirement["Versions"][$i]) risulta presente nella macchina"
  }
  else {
    invoke-WriteCheckLogs "La versione $($requirement["Versions"][$i]) non risulta presente nella macchina"
    $missingVersions += $requirement["Versions"][$i]
    $missingDownloads += $requirement["Downloads"][$i]
  }
}

$requirement["Versions"] = $missingVersions
$requirement["Downloads"] = $missingDownloads
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUnWLCjPFrhlQQ3v1C4NFc3U4D
# suOggh6kMIIFOTCCBCGgAwIBAgIQDue4N8WIaRr2ZZle0AzJjDANBgkqhkiG9w0B
...
# DjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBRmviXOe6S9/7u2s731hcWr
# Y4xTfTAkBgorBgEEAYI3AgEMMRYwFKASgBAAQwBBACAAVABvAG8AbABzMA0GCSqG
# SIb3DQEBAQUABIIBAJHgzixvQeLs/F7JIpbei1srktQ8ssXecHFd12rh/ISUQNU7
# kiTAh1cpTFhX8idSqjJCNFdT52ZlU4cm97glLNfvOElUlFxQ1ZattrlWSr17T1Xp
# c8Gh0BAQP91YQvd/JK+rWI+GaolT24tx0vVgohVFLMAtTw6TeUbIjYE6GztsyPJz
# f2Ml1F1gpT8lrRmHMAwlSaQCDbRp1dTs7D6QL7mOTCV8KVmOPFY9S0AfFDA5qy3L
# e5l8asWuok8ao0riWZpyrPahYhHP193PLm+wrcISRU4QybQbvb9bNGzems/KklPy
# 0hCfx4RKBkVRug4YmMJqmRrT12zBfElku/ac8oihggNLMIIDRwYJKoZIhvcNAQkG
...
# CSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcNMjMwNTI1MTEwNTUyWjA/BgkqhkiG
# 9w0BCQQxMgQwdh5Eq/FmSdgtmjzqjF5xlarGwIJceR4b5d8wEri7W2w0jJ7W5qko
# KnDlv4pF/ASOMA0GCSqGSIb3DQEBAQUABIICAI0XmietfXT49oQt4hrLQzrESwIS
# uziNGqiBYEk7tM20OutfSgosjxTJpuRsnpM6EMz44qYfK1u2g7ImMoB1S0sgBuEk
# qlIT6qNqvuh5wKl81hu3ts9fpD9IRkiIxUCd+s2JHmERIXmt0qJV+yZyauv25h1v
# n75PGsGL62fy/UMRC80h6kRueA2krkAlvJoFBB2uKrrSfOj5J73izc2QKADSgOP0
# C0kMo0x6QEL9G5d1o3wZfSoBKoih1acVVT4/Le0z/BYXKfD1mBbJrtMkawEGMKe8
# 3+l49dMqyZAWnA2wLqbLaJKJOfloPw4DibbCC5LlTu2/pTFyIj4djstKfJZ4MqcE
# yD6FA6N5B1wIogGfq9yfiOPhoKnHi9WgcIB2uPNIl82EbJASgw414gx+91Krtiea
# V7PY+JUhERTg02V4Eq/Gaf2phJHTmEUEsRWeH8v/BaIA7cPvXkFa7SBTyjNNZXTJ
# cSfMmLBHICFKyQRb9dDjNH1C2wZYqWzJqRzUP7wtgskM051BJVtr0hkRwqGlSvkz
# 3q9pz7VwcImqNCsYOjYtNwwqJdOHsAxyasbhhWVeheJ6IEms/hSOVmisAbLQZzdz
# /D5w/W3B1MPSkV5ADVEJngwyW9dHxwwh8aLxPjAP3bxQ8r1mOov5cOkYxDKBbtGe
# aNahZZ2lgWpHWXnE
