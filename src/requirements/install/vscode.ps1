function invoke-installing ($requirement) {
  ...
  invoke-WriteInstallLogs "\r\nInstallazione di $subMessage... in corso"
...
function invoke-settings ($name) {
  ...
  invoke-WriteInstallLogs "\r\nAggiornamento impostazioni in corso:"
...
function invoke-extentions ($name, $requirement) {
  ...
  invoke-WriteInstallLogs "\r\nInstallazione estensioni in corso"
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUguuM6f0ZQ0n363oCupRNNiTo
# 0a6ggh6kMIIFOTCCBCGgAwIBAgIQDue4N8WIaRr2ZZle0AzJjDANBgkqhkiG9w0B
...
# DjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBR/tNECbWMVv14600y2ajCR
# AvXFtTAkBgorBgEEAYI3AgEMMRYwFKASgBAAQwBBACAAVABvAG8AbABzMA0GCSqG
# SIb3DQEBAQUABIIBAGQcHjvxqtoBzouSnGg6jj1pG3rlwdaz1rvbi4z8qK98LOd0
# P88EcMlpoHterw38/gw/WCWl7fSjWRV9BVhkmWMBjf4YletCPJyhtLPJ3lALvsCS
# Qg0TTKACV7tTCR0qFGyfWTCvuO38BZvUKgbxZwQF6295yClwhUMuM/GXqWxnL7o1
# lt9UuAyYnVS99UvvUIcNWyHj9F73HRU+XXg1qZn1L4MGYvV9l1b0w3Sinx6CnW5p
# fQSDl4HBEluxkWmoKb/rC8IVN8q5LXHSPqqRFetOK/tq8fgJYNZJDo6zLzQvSXcS
# 6GSn9vCSKWxHnmGfx0o8F9TZx7Z/F0VqIGlIhmehggNLMIIDRwYJKoZIhvcNAQkG
...
# CSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcNMjMwNTI1MTEwNjQ4WjA/BgkqhkiG
# 9w0BCQQxMgQwYS6HSSvtn4Yw5dwEguYn29pMObGuwZF9wTLypENvf/3MDRRTcU4X
# XcBAUxuQPCs7MA0GCSqGSIb3DQEBAQUABIICACASb6vcKvXaw6fdsvA/qSaTb91W
# Nk0GvmhRfkd6VPo9t27hRUahCzIVuUOd6D0ns4Qw153wBlFatvBFdqu+zJEOjlzL
# WhzOQR8qZ9HPplzBhYSTmkn3emHrT2GwiQ1TgTuMOil3UC7U/S8tAMHK+WYGzVNo
# tAxaIMLTcgdZauqADCLN7UOnBYRTqeesWyIABvkMz3o+89q7EHsEzN0WDIFoUBOR
# on/rTVcHbGfCk0BUXGfi420nSW+tlic/vKlDpRqbdyE605O4a8d59kEZoM+hitrz
# ExRtn4AhF1jsD5sgoEulj6BIjwqZP2KEskJGZj2C5R6H7IuBgH9AzsJEp9OXiAYo
# K7fWfoTJs7vqUJkv1HqkGTt8AU9JIdO9YXyTUU9O6B/odOpDfaO89tKpmiThwZn6
# pOngqqd2jSxjFmppEBYohqruMFCnYHTKjffbZkD4L7h2wnbIj83BldTghv/mkH7M
# JqZdh1I569IjZ3S18g6QNwCKFHSXBAsOO5hIrKflAdcPs9215UwkpBkWxAXur1LB
# yuuOaiwlLgx9a5M0LFuAd7fXdjQAiOZ4/22DaxGYbIHShg+hrT2LckmmZROsV78F
# h6lcOotaTeviW1YDjKFoUXLoVy756WIOQFjO80kfNql3xC/70DVHu/AHM4teQ1nw
# KKUdDIyYS6VelcwI
