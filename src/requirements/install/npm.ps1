function invoke-installing($name, $requirement) {
    ...
    if (($checkLogs["Node"]["Result"] -ne "OK") -and ($installLogs["Node"]["Result"] -eq "OK") -and ((npm --version) -eq $requirement['MaxVersion'])) {
        invoke-WriteInstallLogs "Npm gia' installato con Node"
        return $true
    }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUuwKjwuYcqEiVVAd2Km/EbqQM
# F7Gggh6kMIIFOTCCBCGgAwIBAgIQDue4N8WIaRr2ZZle0AzJjDANBgkqhkiG9w0B
...
# DjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBRr/AVVbt6AzVsq3Zdupjvo
# kpH5bDAkBgorBgEEAYI3AgEMMRYwFKASgBAAQwBBACAAVABvAG8AbABzMA0GCSqG
# SIb3DQEBAQUABIIBAIveU8/J+T7XeA0CzAeAatL4jwr5u7E6nPAHeDKrkD55T5Ft
# AnoN/s+NmGIJsED61QBXzo88uj1jSsnKrBgvMoDrKcJQM2xyOqGJX0MHrcIgdarB
# 4y2vlHMtgNSQilcGPJ8NI9qOcAetUpkIsVBrBmI0gTvDf64UovPYxKOOu2tuWBxi
# z6DZewYQHcuV6Z4PAemdvZr4UpXnx6np54kQfIvfqYyBjhkIXOz4zjknT+bn8jVk
# 1EjyYaMphUAJGLhROgbRval2mXrcZ/woCJpSYa1UEq0uzGyxEaKQr4O1T55XLMEk
# rHdy73kKhldNfcR3UVnOxb711AqU9/PmDphe6pWhggNLMIIDRwYJKoZIhvcNAQkG
...
# CSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcNMjMwNTI1MTEwNjQwWjA/BgkqhkiG
# 9w0BCQQxMgQwq0l4bG5u/H+SNAumnsJ4LNNnA4vVatqWpBJ9YW49hO+zKkh8Edim
# ZiWHJDFpp+dIMA0GCSqGSIb3DQEBAQUABIICAGYmInL2IBGOKK+NXGtxzRM4fgO9
# K08LOcHx5Vt9aY5+2WagMUeaJeWxAWHNCuDY4g6afZRmdbvPn+zh4dhnxCWXUT93
# 9XCMjOiZc0/AeYfEhzOuFeFxzG7kJT5gdxzOa2hlJ1fTyhNwtMb12b2K7k4eUbe2
# eFxDxqSA8H1YbiiHV76K/Io9sf6miurzK+lgVYmf36XOsY//Kcg2UiUTaNboHw0z
# ssEhZ44x7i7Tb4cs07P/Y4rLtukH9QCo+PmC8XqPcrO1QjZ5GnuunYEfGlT6yQsj
# cIaQoy6bAHqx6psVOa1AVzD0lt1ZmkFKkCq3NYIaXP2014WmnL7MMI2Mao4jG0fB
# +klUScElo1D8UO/yfc8HJKrrCuZYDZ2+etWNxv8pvYCOybpQQ8iA+h2zQK0j0N6k
# Ll0oFV2zEzgeP0IbvOPnQMUwn7gtycLLvpU/hiwZmh6KJ7JKQqZrA7sbyrTk9WQF
# P6yA07zNl/fojN0Qf8+cmnD9JLzg/HlPAMmP5u78oI3gfdqMt6TWEUbTMy01ZK85
# I3Ng6TTs9BW9/rDAWk1T0Shw9oxfxbGuPfwMqv3O2cHLDfkKQ5OOEuQl/bwnaUbG
# 5szH0haDcvMqUFiNtSDJOFyGEap1iE7/DJKeqow43zLKgZVfZvsUSaXzbke0JLhl
# qpgQjNBjn5EvKeUi
