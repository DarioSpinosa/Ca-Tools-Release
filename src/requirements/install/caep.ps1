...
if ($checkLogs[$name]["Result"].Contains("FILE")) {
  invoke-WriteInstallLogs "\r\nDownload npm login tool $("$env:PROGRAMFILES/Ca-Tools") in corso..."
  if (-not (invoke-executeInstallCommand "Copy-Item './src/components/login/npm-login.ps1' -Destination '$env:PROGRAMFILES/Ca-Tools/npm-login.ps1'" "Errore durante l'installazione del tool di login per npm")) { return "KO" }
...
if ($checkLogs[$name]["Result"].Contains("PLUGIN")) {
  invoke-WriteInstallLogs '\r\nInstallando @ca/cli-plugin-scarface...'
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUg1aNSGgtFVhF7u4o8FlCW9Ta
# tlSggh6kMIIFOTCCBCGgAwIBAgIQDue4N8WIaRr2ZZle0AzJjDANBgkqhkiG9w0B
...
# DjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBRT24RCL/cznd7dxOdZcnBd
# RET+azAkBgorBgEEAYI3AgEMMRYwFKASgBAAQwBBACAAVABvAG8AbABzMA0GCSqG
# SIb3DQEBAQUABIIBAKyeQxyfjOvZG2VTGkOF3JYQMeIo5UAPXCfCvYdqqGttlb12
# yqnarlwhCPYpdOSKMiPn/tGnShwxYCy3KgswRn0Cco6gYnO3Q0t0jwuV55xkoxT3
# lPQlSIaHwXrr6rLJSVxdJFS/OH0FVy6iKPx7fsXnWgjtloAbzH3Le05fThZxqeeS
# 5+/Urvk+33Tg+YuIqw6/OXcFtOCrFbX79GSrj9VITikXog2blzk/OYGikSP1WIg6
# LbyBtsKxmC6SRYTG3GNhS95si4GviJTLFTJBbNZbvPq0ELCvc5eZRlTxMM6tNFEI
# d5C1z77g+tTRmRPdaTlhpm/pqlCVQ//a8SaR9HKhggNLMIIDRwYJKoZIhvcNAQkG
...
# CSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcNMjMwNTI1MTEwNjIyWjA/BgkqhkiG
# 9w0BCQQxMgQwhHmVwHekpD5iMMChJ0Iz1Be7TpfPrcZIAApNakM2bnSIkrz4J7u9
# WkslKT//l/1XMA0GCSqGSIb3DQEBAQUABIICAH1sIpavYxyNh4vojDOCiP3LZIXq
# MDVfTGvOdRVfPQu8Ak9INCguzQvA7TnMKzfrRUFhuh91G253EMEZQDPw/0qy0tv5
# mlJsUbkfGsfAXNUJ+zng3AyXwjnLL1VVyJG7kD0iAFVzlULAv8mxbTb0MyzLzk1l
# CRyGSjQWs92RoQPGpr8Q847QdJ7ZEOEmlYXPrqFDHbsrv3is+MBGscpVqm5GI19+
# /JP5kfS+n9frDRI/fgAcFU4NGC/1Fg7Fl/Cal9h7gTu4khILe9pEDtH7JZTRs+v9
# vTuGzLyYksFVJIMpfve+LRoTtEYfYsoIDvrwbz3cMM4hEbdRhYomWVblyeUsXKYE
# 6E1wCmQMjtlR27HTeeOxUb0tSApzAupJ85ysXkUI7VleVgTIGwX0MvIaEfBRWFun
# rBzHNPMS7MVnfvY0Oe8/2V8BtO/+PkJYvcxTWtPmnbp6Fh+EgWx0Xua5u9rATOVZ
# t36U+SCa1qZTpPxB/fa8+dibQKqybB5orYuDkI4Gk+Su/SyCZfQOg+2qJDtEgF60
# Mmgn+WcILpr9lLskugI2sZ0FMIVFns2jocUEniMxzSPBdgUPC3mfxYRU6ViBhA67
# ImVpuE9kU7taVNx7aCc+sKekjjvnYaeZwbc5JJtRFfDkj77tXD/0GdoXe5gQJwaO
# SUo9qoAMPdwRUcwK
