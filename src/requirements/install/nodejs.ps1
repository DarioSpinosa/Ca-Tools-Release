function invoke-installing($name, $requirement) {
	...
	if (-not (invoke-executeInstallCommand "Start-Process msiexec.exe -ArgumentList '/I $($requirement["DownloadOutFile"]) /passive' -Wait" "Errore durante l'installazione di $subMessage")) { return $false }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUGwHmYQ3XXvtpoiEDTwa0xS+h
# vU2ggh6kMIIFOTCCBCGgAwIBAgIQDue4N8WIaRr2ZZle0AzJjDANBgkqhkiG9w0B
...
# DjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBQKPnEgIBbxFHS4DtVchzcV
# xmE59DAkBgorBgEEAYI3AgEMMRYwFKASgBAAQwBBACAAVABvAG8AbABzMA0GCSqG
# SIb3DQEBAQUABIIBAKd19KqYfjdb92WrWJ5nE2ptD6kiRx0kDsxUMrdPez1n8bmW
# f99lBY+gH52Cof9hEKaTncOj4UCuOcGVBQGV8BwHKJKwtWLgvAX1WTURh4fVebT9
# ukpE2QXUVF5oG2HFXfuVXl5sEIT57NYLDF79LkZhwShVitoa/lIz27n+JuC/5ZmV
# diuGC62YZDDVUe7wlruNsZIx72QRuW3iO+mbMEpoRvXbTZt7BCNp0/75HvQNj2bq
# za9MHSmEYawCPwz/PUlNcztn58wCDsnRwjWOqR07bqj5xkxe41pw55HJar2D/zpX
# XMe55AafZqnBW306+Frf5X6MuB874Ckao/C66YOhggNLMIIDRwYJKoZIhvcNAQkG
...
# CSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcNMjMwNTI1MTEwNjMzWjA/BgkqhkiG
# 9w0BCQQxMgQwSu36YP2qD4gJ3M0R2oTqDkqEIN5X9f2jj7eAxCR07b74CO+gnMcZ
# DJxJ2d4RPL9RMA0GCSqGSIb3DQEBAQUABIICAGKkRMj4Say9YReIClaVtRFRkgMx
# uAkXMIc0z5pR3WLolkfgjOf+qozB1UqSN0onvCcnm2igHj5jezw5vaJX0KFvfIQV
# hsDYFW/eAd12V6I5j8MIbSE9NL1Mr/iWtfdYKaaT5u6gUd3IK38fRZV+UdQsxFVF
# PMIp0SHiVnfVRxpK+sEuyY/HQMAR7d9scbl+iBhVUQWdAAjF2aB4ZmYWeQfJtcH1
# JVrVVvLTkrRsxy0mhLmV/J+U4TKSib3fL31B2pnIuPGaf6a0HeQxuO344Q01DIUR
# m5sr8KIHlHfjOVyxS4sc/Xp3oo9s6qX4sQvyHu87mKmnDkO+YzMsKPnZ15E26DC2
# LPLrN8y2TzA+sM3zFlzUc5A5JmMmp5XFIfwBApSQMRm7o8fnfNrL4lf5yC+SKAb8
# 5s+FYBwflli1P+oGTvAOo0jkkk+OQTWLJxNU4S4I6tsaAD+d3N/aSOTJNneKiA3q
# BzMkmkbZjX+N+zYlSnfUG9UcyuNmVOji02NAl+GkC7nrc8AZN3bOMZGBuJD5NIfT
# K+z+rlB3h1ZYAkkt88PK5lIXJIcCorVs/zd2W4kla5tcWtaeOapEBJlIOGyB+pMr
# H3KaEnajtAFSYR3ywZA2uhU2EfnJppHCjm82uQ/5ObWhY+qW7mkxlLtTwdI3SgvL
# BaNRcDbwKjyejTVd
