function invoke-installing($name, $requirement) {
  $subMessage = "$($name) version: $($requirement["MaxVersion"])"
	invoke-WriteInstallLogs "\r\nInstallazione $subMessage in corso..."
    
  if (-not (invoke-executeInstallCommand "Start-Process $($requirement["DownloadOutFile"]) -ArgumentList '--add Microsoft.VisualStudio.Workload.NetWeb --add Microsoft.VisualStudio.Workload.CoreEditor --add Microsoft.VisualStudio.Workload.ManagedDesktop --add Microsoft.VisualStudio.Workload.Universal --passive --norestart' -Wait" "Errore durante l'installazione di $subMessage")) { return $false } 
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUVXy+svEIjNdgdyVntnx8HA/q
# Z7Cggh6kMIIFOTCCBCGgAwIBAgIQDue4N8WIaRr2ZZle0AzJjDANBgkqhkiG9w0B
...
# DjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBSa+nGvEyuTgeZDSVndRHPp
# ST6F0zAkBgorBgEEAYI3AgEMMRYwFKASgBAAQwBBACAAVABvAG8AbABzMA0GCSqG
# SIb3DQEBAQUABIIBAFgi9j5pvD19n0tB+P/j5fV5v1jcYGdcb2coREo2OnKCnEN5
# Rwf1JaOXEqI/psQ8lco/QHvKlhy/ww72PSYDDCzenOvGoGmQRfYEbRbnMQeIxEwV
# 1tRfD5OnzSVd0X5+U8zEg0X13ZmeUFUpdxbpYfWoxKjG/Rg69tYkimTxsNVPa/UG
# JUujZfo8mLyFsoBvib9zQsPUz29Hc1cax+k6h1A1/Yia470sSTKytBvu784bynQ9
# suooAE7zEcZo+Q9DFQZ3pb3xTOZ2xeA6PzE4jrRLONMYSBrw9oRns+/0DNTHCrYo
# 3jBODMJ107p/CE1axpSmDATIUGG/nk/vpgyXn9yhggNLMIIDRwYJKoZIhvcNAQkG
...
# CSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcNMjMwNTI1MTEwNjQ2WjA/BgkqhkiG
# 9w0BCQQxMgQwSKCyObNtEV0XOpkJWaZzObBZe780ipI6H5kdC7LIRbNK4CiwFYCk
# rkkhLAyQ3RsOMA0GCSqGSIb3DQEBAQUABIICABg7PMfMiv5aik6cnAVR5aNwiBpk
# j7hk7JZYgdULnzLbCfv9NBKJan7OjPNtj5zmMZ78lGf7phAw321FHvv0/6UdYBSJ
# MdwPwFqCs0yuFDgzxPoqK+Jr2QmJHmeBT0w3xXhpR3D/g9c+yoU6MXczxnnTLbjR
# nPSDk7Wnupo7nSyPFJyeqpOQlog6H3V/xd0RPyePXj4ybJQ94drqn4mpcrG++xPJ
# 2JalZr0/+KasLbSh0ERfTDb7pqQiWqpue3THwnNVsbmtnP0d+IQ6guZyYalyWpnJ
# t8t695PsiNOZP/EyS4wBX6plJzpOrVkBQ72MZx0r5oe7oCYZufh6lx6T3g12arSh
# 5BQQo5zhZTeddwfQIbwJ5bg2rvl+qvpevLFaB6E0na5VnO1hQxopb+QbnFFkYZ9e
# n4tRmsqsW8jl6GWe5gy0Pz1VTvNkHQ5FnjdvAT5+RGzz7mDITookXobhkkhVVKQN
# sw+4J5W83b56YpVjaaZDawcOaZ0AmeIcoUckG57sf8gx1boZyXrVquA1izRu47U2
# D/agSRhKvC0AgOCcPRQDFG+MzXyf+TIfNlUpqAlRBf2n4y8LsE/Y170x8T9U5z5+
# CMf8hsjWKDSb74PN06lxOuDzV7PFn4EZax3khRkP5+UTh/5xwQn6jiaCm/i24zLi
# Bu1io6+zAmvcmgiD
